...
\newline \textbf{Technologies}: Java 8 (+ Guava, Guice, JUnit, JMockit, ...), Cassandra, Zookeeper, RabbitMQ.}
...
%Section
\section{Skills}
\cvline{Basic}{\small Haskell, Spark}
\cvline{Pet-projects}{\small \textbf{General purpose} (Scala, Ruby), \textbf{web} (React, Redux, NodeJS, AngularJS, Ruby on Rails, PHP), \textbf{mobile} (Android)}
\cvline{Professionally}{\small \textbf{General purpose} (Java, Python, C/C++), \textbf{databases} (Cassandra, PostgreSQL, MongoDB), \textbf{other} (RabbitMQ, Unix, git, Docker, algorithms, concurrency/multiprocessing, distributed systems, Agile), \textbf{web} (Javascript, jQuery, HTML/CSS)}
\vspace{-3mm}
